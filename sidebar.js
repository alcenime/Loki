(function () {
  ...
  function buildSidebar(activePage) {
    ...
    const logoSrc  = 'assets/dashboard/logoloki.jpg';
    ...
    <div class="sidebar">
      ...
      <div class="sidebar-portrait">
        <div class="wolf-medallion">
          <img src="${logoSrc}" alt="Loki" style="width:100%;height:100%;object-fit:contain;position:relative;z-index:2;opacity:0.85;">
        </div>
      </div>
    </div>`;
  }
